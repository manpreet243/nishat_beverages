...
export const mockCustomers: Customer[] = [
    { 
      id: 1, name: 'Ibrahim Pasha', houseNumber: '123-B', floor: 2, flat: 'Apt 201', mobile: '923331122333', 
    ...
    { 
      id: 2, name: 'Fatima Jinnah', houseNumber: '45-C', floor: 1, flat: 'Ground Floor', mobile: '923214455666', 
    ...
    { 
      id: 3, name: 'Zain Abdullah', houseNumber: '88-F', floor: 5, flat: 'Penthouse', mobile: '923118877665', 
...
export const mockSales: SaleRecord[] = [
    { id: 1, customerId: 1, customerName: 'Ibrahim Pasha', bottlesSold: 2, amountReceived: 200, date: new Date().toISOString().split('T')[0], salesmanId: 1, bottlesReturned: 2 },
    { id: 2, customerId: 3, customerName: 'Zain Abdullah', bottlesSold: 1, amountReceived: 0, date: new Date().toISOString().split('T')[0], salesmanId: 1, bottlesReturned: 1 },
    { id: 3, customerId: 2, customerName: 'Fatima Jinnah', bottlesSold: 1, amountReceived: 100, date: '2024-05-20', salesmanId: 2, bottlesReturned: 0 },
    { id: 4, customerId: 0, customerName: 'Counter Sale', bottlesSold: 0, amountReceived: 50, date: new Date().toISOString().split('T')[0], isCounterSale: true, description: '3 small bottles', bottlesReturned: 0 },
];
...
export const mockInventory: InventoryItem[] = [
    { id: 1, name: '19-Liter Bottle', category: 'Containers', stock: 150, lowStockThreshold: 50 },
    { id: 2, name: 'Bottle Caps', category: 'Supplies', stock: 800, lowStockThreshold: 200 },
    { id: 3, name: 'RO Filters', category: 'Parts', stock: 15, lowStockThreshold: 5 },
];
